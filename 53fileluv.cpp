// question with binary search and predicate function
// predicate function :- function that returns true or false
// monotonic predicate function:-
// jo kisi point se pahle false return kare then true hi return kare
// Ex. f f f t t t t
// or
// jo kisi point se pahle true return kare then false hi return kare
// Ex. t t t t f f f
...
/*
Q.1. Lumberjack Mirko needs to chop down M metres of wood. It is an easy job for him 
...
parts that were cut off. For example, if the tree row contains trees with heights of 20, 15, 10, and 17 metres, 
...
// where n is array size and H is height of maximum tree
